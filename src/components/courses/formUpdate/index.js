...
return (
  <Fragment>
    <GridList>
      <div>
        <H3>Nombre</H3>
        <InputStyled value={nameCourse} onChange={(e) => setName(e.target.value)}/>
      </div>

      <div>
        <H3>Tutor</H3>
        <InputStyled value={tutorCourse} onChange={e => setTutor(e.target.value)}/>
      </div>

      <div>
        <H3>Descripcion</H3>
        <InputStyled value={descriptionCourse} onChange={e => setDescription(e.target.value)}/>
      </div>

      <div>
        <H3>Nivel</H3>
        <SelectStyled value={levelCourse} onChange={e => setLevel(e.target.value)}>
